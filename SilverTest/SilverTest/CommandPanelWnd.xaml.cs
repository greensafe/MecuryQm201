            ...
            Dispatcher.BeginInvoke(new Action(() =>
            {
                switch (result)
                {
                    ...
                    case 2:
                        ...
                        //取样流量
                        fluentblk.Text = Utility.MapSampleFluent( res_datas[1]-0x30);
                        //高压值
                        pressureblk.Text = ((res_datas[3] - 0x30) * 100 + (res_datas[4] - 0x30) * 10 + (res_datas[5]-0x30)).ToString();
                        //主道放大倍数
                        enlargeblk.Text = (res_datas[6]-0x30).ToString();
                        break;
                }
            }));
        }
